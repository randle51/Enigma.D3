...
namespace Enigma.D3.Enums
{
	public enum AttributeId
	{
		...
		DoubleBountyBags = 1383,
		JewelUpgradesUsed = 1384,
		JewelUpgradesMax = 1385,
		ItemIgnoresPickupRadiusForPickup = 1386,
		Hunter = 1387,
		ParticipatingInTieredLootRun = 1388,
		TieredLootRunRewardChoiceState = 1389,
		TieredLootRunRewardReceivesKey = 1390,
		CurrentCosmeticEffect = 1391,
		BloodshardBonusPercentPotionBuff = 1392,
		XPPotionBuffExpiration = 1393,
		GoldFindPotionBuffExpiration = 1394,
		BloodshardPotionBuffExpiration = 1395,
		CurrentCosmeticPet = 1396,
		CosmeticPetPower = 1397,
		CosmeticPetExpiration = 1398,
		CosmeticPortraitFrame = 1399,
		HQHotColdState = 1400,
		HQCursedRealmReagentsCollected = 1401,
		HQCursedRealmReagentsDropped = 1402,
		DebugMovementType = 1403,
		TieredLootRunDeathCount = 1404,
		TieredLootRunCorpseResurrectionAllowedGameTime = 1405,
		LastPostedAchievementPoints = 1406,
		CosmeticPetActor = 1407,
		PlatinumCapRemaining = 1408,
		PlatinumCapLastGain = 1409,
		LastBossKillTime = 1410,
		LastBountyCompleteTime = 1411,
		LastTreasureGoblinKillTime = 1412,
		StashTabsPurchasedWithGold = 1413,
		SkillButtonFlash = 1414,
		ProjectileDetPathReflectCount = 1415,
		LastCosmeticPet = 1416,
		PlatinumLastSignificantKill = 1417,
		PowerLastAttributeSnapshotUpdateTime = 1418
	}
}
