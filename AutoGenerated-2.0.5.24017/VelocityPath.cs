public class VelocityPath : MemoryObject
{
	// 2.0.5.24017
	public const int SizeOf = 0x30; // 48

	public VelocityPath(ProcessMemory memory, int address)
		: base(memory, address) { }
	...
	public VelocityNode[] x24_PtrArray { get { return Dereference<VelocityNode>(0x24, x20_Count); } }
