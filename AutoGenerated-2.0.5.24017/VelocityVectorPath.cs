public class VelocityVectorPath : MemoryObject
{
	// 2.0.5.24017
	public const int SizeOf = 0x30; // 48

	public VelocityVectorPath(ProcessMemory memory, int address)
		: base(memory, address) { }
	...
	public VelocityVectorNode[] x24_PtrArray { get { return Dereference<VelocityVectorNode>(0x24, x20_Count); } }
