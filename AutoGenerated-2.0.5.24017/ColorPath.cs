public class ColorPath : MemoryObject
{
	// 2.0.5.24017
	public const int SizeOf = 0x30; // 48

	public ColorPath(ProcessMemory memory, int address)
		: base(memory, address) { }
	...
	public ColorNode[] x24_PtrArray { get { return Dereference<ColorNode>(0x24, x20_Count); } }
