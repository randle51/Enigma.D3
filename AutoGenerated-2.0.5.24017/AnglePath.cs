public class AnglePath : MemoryObject
{
	// 2.0.5.24017
	public const int SizeOf = 0x30; // 48

	public AnglePath(ProcessMemory memory, int address)
		: base(memory, address) { }
	...
	public AngleNode[] x24_PtrArray { get { return Dereference<AngleNode>(0x24, x20_Count); } }
