public class MadeToOrderTypesEntry : MemoryObject
{
	// 2.0.5.24017
	public const int SizeOf = 0x130; // 304

	public MadeToOrderTypesEntry(ProcessMemory memory, int address)
		: base(memory, address) { }
	...
	public RecipeIngredient[] x110_Array { get { return Field<RecipeIngredient>(0x110, 3); } }
