...
namespace Enigma.D3
{
	public class SceneManager : MemoryObject
	{
		public const int SizeOf = 0x508; // 1288
		...
		public Map x408_Map { get { return Read<Map>(0x408); } }
		...
		public BasicAllocator x490_DynAllocator { get { return Read<BasicAllocator>(0x490); } }
		...
		public LinkedList x4B8_List { get { return Read<LinkedList>(0x4B8); } }
		...
		public int x4D8 { get { return Read<int>(0x4D8); } }
		public int _x4DC { get { return Read<int>(0x4DC); } }
		public BasicAllocator x4E0_DynAllocator { get { return Read<BasicAllocator>(0x4E0); } }
