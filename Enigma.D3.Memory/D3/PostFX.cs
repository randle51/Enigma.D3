...
namespace Enigma.D3
{
	public class PostFX : MemoryObject
	{
		public const int SizeOf = 0x428; // 1064 // TODO: Update to match size
		...
		public int x00C_ArrayStart { get { return Read<int>(0x00C); } }
		...
		public int x04C_ArrayStart { get { return Read<int>(0x04C); } }
		...
		public int x094_ArrayStart_ { get { return Read<int>(0x094); } }
		...
		public int x0DC_StructStart_x300Bytes { get { return Read<int>(0x0DC); } }
		...
		public int x104_StructStart { get { return Read<int>(0x104); } }
		...
		public int x40C_Count { get { return Read<int>(0x40C); } }
		...
		public int x420_TextureSnoId { get { return Read<int>(0x420); } }
		...
		public int x470_Struct_64Bytes { get { return Read<int>(0x470); } }
