...
namespace Enigma.D3.UI.Controls
{
	public class UXControl : MemoryObject
	{
		...
		public int x008_Method { get { return Field<int>(0x008); } } // Clicked ItemsControlBase
		public int x00C_Method { get { return Field<int>(0x00C); } } // Clicked (something else)
		...
		public int x01C_SoundSnoId { get { return Field<int>(0x01C); } } // Used with x008
		public int x020_SoundSnoId { get { return Field<int>(0x020); } } // Used with x00C
		...
		public int x444_Tag { get { return Field<int>(0x444); } } // Can be any 32-bit data, typically an ID such as SNO or ACD.
