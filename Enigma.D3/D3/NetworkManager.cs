...
namespace Enigma.D3
{
	...
	public class NetworkManager : MemoryObject
	{
		...
		public int x004_SocketHandle { get { return Read<int>(0x004); } }
		public int x008_IsClosed { get { return Read<int>(0x008); } }
		public int x00C_Ptr_32768Bytes { get { return Read<int>(0x00C); } }
		public int x010 { get { return Read<int>(0x010); } }
		public int x014_Ptr_32768Bytes { get { return Read<int>(0x014); } }
		...
		public int x028_IsConnected__ { get { return Read<int>(0x028); } }
		...
		public int x03C_Method { get { return Read<int>(0x03C); } }
		...
		public int x04C_Method { get { return Read<int>(0x04C); } }
		public LinkedList<Ptr<NetworkMessage>> x050_OutMessageList { get { return Read<LinkedList<Ptr<NetworkMessage>>>(0x050); } }
		public int _x060 { get { return Read<int>(0x060); } }
		public LinkedList<Ptr<NetworkMessage>> x064_InMessageList { get { return Read<LinkedList<Ptr<NetworkMessage>>>(0x064); } }
		...
		public Allocator x07C_Allocator_10x12Bytes_ListNode { get { return Read<Allocator>(0x07C); } }
