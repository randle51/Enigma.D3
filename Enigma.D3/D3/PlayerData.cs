...
namespace Enigma.D3
{
	...
	{
		public static PlayerData Local { get { return Engine.TryGet(engine => Storage.Instance.x10C_PlayerDataCollection.x0038_Items[Player.Instance.x00000_LocalDataIndex]); } }
