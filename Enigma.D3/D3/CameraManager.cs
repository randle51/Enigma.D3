...
namespace Enigma.D3
{
	public class CameraData : MemoryObject
	{
		...
		public float x004_StructStart_Min1124Bytes { get { return Read<float>(0x004); } }
		public float x008 { get { return Read<float>(0x008); } }
		...
		public float x044_AspectRatio { get { return Read<float>(0x044); } }
		public float x048 { get { return Read<float>(0x048); } }
		...
		public float x08C_X { get { return Read<float>(0x08C); } }
		public float x090_Y { get { return Read<float>(0x090); } }
		public float x094_Z { get { return Read<float>(0x094); } }
		public float x098_X { get { return Read<float>(0x098); } }
		public float x09C_Y { get { return Read<float>(0x09C); } }
		public float x0A0_Z { get { return Read<float>(0x0A0); } }
		public float x0A4_X { get { return Read<float>(0x0A4); } }
		public float x0A8_Y { get { return Read<float>(0x0A8); } }
		public float x0AC_Z { get { return Read<float>(0x0AC); } }
		public float x0B0_X { get { return Read<float>(0x0B0); } }
		public float x0B4_Y { get { return Read<float>(0x0B4); } }
		public float x0B8_Z { get { return Read<float>(0x0B8); } }
		...
		public Struct x14C_StructStart_Min64Bytes { get { return Read<Struct>(0x14C); } }
		//public float _x150 { get { return Read<float>(0x150); } }
		...
		public Struct x18C_StructStart_Min64Bytes { get { return Read<Struct>(0x18C); } }
		...
		//public float _x1A0 { get { return Read<float>(0x1A0); } }
		...
		//public float _x1B4 { get { return Read<float>(0x1B4); } }
		//public float _x1B8 { get { return Read<float>(0x1B8); } }
		//public int _x1BC { get { return Read<int>(0x1BC); } }
		//public int _x1C0 { get { return Read<int>(0x1C0); } }
		//public float _x1C4 { get { return Read<float>(0x1C4); } }
		//public int _x1C8 { get { return Read<int>(0x1C8); } }
		public Struct _x1CC { get { return Read<Struct>(0x1CC); } }
		...
		//public float _x1E0 { get { return Read<float>(0x1E0); } }
		...
		//public float _x1F4 { get { return Read<float>(0x1F4); } }
		//public float _x1F8 { get { return Read<float>(0x1F8); } }
		//public int _x1FC { get { return Read<int>(0x1FC); } }
		//public int _x200 { get { return Read<int>(0x200); } }
		//public float _x204 { get { return Read<float>(0x204); } }
		//public int _x208 { get { return Read<int>(0x208); } }
		public float x20C_StructStart_Min16Bytes { get { return Read<float>(0x20C); } }
	...
	public partial class CameraManager : MemoryObject
	{
		...
		public int x13B0_Index { get { return Read<int>(0x13B0); } }
		public int x13B4_Count { get { return Read<int>(0x13B4); } }
		public float x13B8 { get { return Read<float>(0x13B8); } }
	}

	public partial class CameraManager
	{
		public static CameraManager Instance { get { return ObjectManager.Instance.IfNotNull(a => a.x9B0_CameraManager); } }
	}
}
