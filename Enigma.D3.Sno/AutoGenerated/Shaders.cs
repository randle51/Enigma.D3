...
namespace Enigma.D3.Sno
{
	...
	public partial class Shaders : SerializeMemoryObject
	{
		...
		public partial class RenderPass : SerializeMemoryObject
		{
			...
			public RenderParams x008_RenderParams { get { return Field<RenderParams>(0x008); } }
			...
			public string x184_Text { get { return Field(0x184, 64); } }
			public string x1C4_Text { get { return Field(0x1C4, 64); } }
			public SerializeData x204_SerializeData { get { return Field<SerializeData>(0x204); } }
			public int[] x210_TagMap { get { return Deserialize<int>(x204_SerializeData); } }
			public int x230 { get { return Field<int>(0x230); } }
			public int x234 { get { return Field<int>(0x234); } }
		}
		
		[CompilerGenerated]
		public partial class RenderParams : SerializeMemoryObject
		{
			// 2.0.6.24641
			...
			public RGBAColor x5C_RGBAColor { get { return Field<RGBAColor>(0x5C); } }
		}
		
		[CompilerGenerated]
		public partial class TextureStageParams : SerializeMemoryObject
		{
			// 2.0.6.24641
