...
namespace Enigma.D3.Assets
{
	...
	{
		public const int SizeOf = 0x2B8; // 696
		...
		public partial class GlobalServerData : SerializeMemoryObject
		{
			...
			public float[] x200_float { get { return Read<float>(0x200, 14); } }
			public float x238 { get { return Read<float>(0x238); } }
			...
			public float[] x27C_float { get { return Read<float>(0x27C, 2); } }
			...
			public float[] x2C8_float { get { return Read<float>(0x2C8, 10); } }
